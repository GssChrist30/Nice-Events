...
export default function HeroSection() {
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            >
                ...
                <defs>
                    <radialGradient id="a" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="rotate(90 428 292)scale(812)">
                        <stop offset=".63" stopColor="#728484" stopOpacity="0" />
                        <stop offset="1" stopColor="#fbeee6" />
                    </radialGradient>
                </defs>
            </motion.svg>
            ...
            >
               <div className="size-2.5 bg-[#728484] rounded-full animate-pulse"></div>
                <span className="text-black">Sublimer vos moments précieux</span>
            </motion.a>
            ...
            >
                Chaque événement mérite une mise en scène mémorable.
            </motion.h1>
            <motion.p className="text-center text-base max-w-lg mt-2"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Nous accompagnons vos événements de la conception à la décoration, avec créativité, élégance et détail.
            </motion.p>
            ...
            >
                <button className="flex items-center gap-2 transition text-white active:scale-95 rounded-lg px-7 h-11" style={{ backgroundColor: '#728484' }} onMouseEnter={(e) => e.target.style.backgroundColor = '#b6c0c0'} onMouseLeave={(e) => e.target.style.backgroundColor = '#728484'}>
                    Commencez ici!
