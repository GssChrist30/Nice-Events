...
export default function Navbar() {
    ...
    return (
        <>
            ...
            >
                <a href="#!">
                    <Image className="h-9 w-auto" src="/assets/nice_events.jpeg" width={100} height={36} alt="logo" />
                </a>
                ...
                <div className="hidden lg:block space-x-3">
                    <button
                        className="px-6 py-2 transition text-white rounded-md active:scale-95"
                        style={{ backgroundColor: '#728484' }}
                        onMouseEnter={(e) => e.target.style.backgroundColor = '#b6c0c0'}
                        onMouseLeave={(e) => e.target.style.backgroundColor = '#728484'}
                        onClick={() => {
